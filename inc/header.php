<?php require dirname(__FILE__) . "/app.php";?>
<!doctype html>
<html lang="pt-br">
<head>
<!-- <base href="<?php //URL;?>" target="_self"> -->
<meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css?family=K2D:300,400,600" rel="stylesheet">
<link href="https://cdn.rawgit.com/michalsnik/aos/2.1.1/dist/aos.css" rel="stylesheet">
<link rel="stylesheet" href="assets/css/styles.css?<?=rand();?>">
<link rel="stylesheet" href="assets/css/media.css?<?=rand();?>">
<link rel="icon" href="img/favicon.ico?345678" type="image/x-icon">
<link href="img/favicon.ico?765432" type="image/x-icon" rel="shortcut icon">
